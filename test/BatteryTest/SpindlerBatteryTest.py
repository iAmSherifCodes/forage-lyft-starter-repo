...
class TestSpindlerBattery(TestCase):
    ...
    def test_spindler_battery_needs_service_when_in_use_for_2_years_or_more(self):
    ...
    def test_spindler_battery_needs_service_is_false_when_in_use_for_2_years_or_more(self):
